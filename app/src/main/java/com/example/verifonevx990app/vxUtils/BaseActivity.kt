...
abstract class BaseActivity : AppCompatActivity(), IDialog {
    ...
    fun showMerchantAlertBox1(printerUtil: PrintUtil, batchData: BatchFileDataTable, dialogCB: (Boolean) -> Unit) {
        alertBoxWithAction(
            printerUtil, batchData, getString(R.string.print_customer_copy),
            getString(R.string.do_you_want_to_print_customer_copy),
            true, getString(R.string.positive_button_yes), { status ->
    ...
    fun showMerchantAlertBoxOfflineSale( batchData: BatchFileDataTable, dialogCB: (Boolean) -> Unit) {
        alertBoxWithAction(
...
interface IDialog {
    ...
    fun getMsgDialog(title: String, msg: String, positiveTxt: String, negativeTxt: String, positiveAction: () -> Unit, negativeAction: () -> Unit, isCancellable: Boolean = false)
    fun setProgressTitle(title: String)
