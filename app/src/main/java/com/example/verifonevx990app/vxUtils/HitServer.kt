...
object HitServer {
    ...
    @Synchronized
    suspend fun hitServer(data: ByteArray, callback: ServerMessageCallback, progressMsg: ProgressCallback, irh: IReversalHandler? = null) {
    ...
    suspend fun hitServersale(
        ...
        try {
            ...
            openSocketSale { socket ->
                ...
                callbackSale(VerifoneApp.appContext.getString(R.string.no_internet_error), false,ConnectionError.NetworkError.errorCode.toString())
                 this@HitServer.callback = null
             }
